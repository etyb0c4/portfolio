...
for (const at of [1500, 3500, 5000, 5900, 6600, 7600]) {
  ...
  const ph = await p.evaluate(()=> document.querySelector('.beninmap')?'world':document.querySelector('.ascension')?'ascension':document.querySelector('.abyss')?'abyss':document.querySelector('.fall')?'falling':'boot')
